...
def plot_boxplot(df, x_col, y_col, title="Boxplot", x_label=None, y_label=None, 
                 figsize=(10, 6), x_tick_labels=None, y_formatter=None, save_path=None, palette="Set2"):
    """
    Function to create a boxplot with an option to save it.
    ...
    - save_path: path to save the plot (e.g., "boxplot1.png")
    - palette: color palette for the boxplot (e.g., "Set2", "coolwarm", or a list of colors)
    """
